Public Class frmAtletas_x_Competencia
    ...
    Shared Property Funcio_Atleta_Competencia As New fAtleta_x_Competencia
    'Private Sub mostrar()
    '    'Try
    ...
    Private Sub btnGuardar_Click(sender As System.Object, e As System.EventArgs) Handles btnGuardar1.Click
        ...
        For Each rows As DataGridViewRow In Me.dgvDataListado1.Rows
            ...
            rows.Cells(5).Value = func.Nuevo_Codigo_Resultado
            atl_x_comp.gid_resultado = rows.Cells(5).Value
        ...
        If dgvDataListado2.Rows.Count > 0 Then
            Try
                For i As Integer = 0 To dgvDataListado2.Rows.Count - 1
                    ...
                    Resultado_Final.gtiempo = dgvDataListado2.Rows(i).Cells.Item("Tiempo").Value
                    Resultado_Final.gposicion = dgvDataListado2.Rows(i).Cells.Item("Posición").Value
                    ...
                    Atleta_Competencia_Final.gid_atleta = dgvDataListado2.Rows(i).Cells.Item("Id_Atleta").Value
                    Atleta_Competencia_Final.gid_resultado = txtIdResultado2.Text
                    Atleta_Competencia_Final.gdorsal = dgvDataListado2.Rows(i).Cells.Item("Dorsal").Value
                    Atleta_Competencia_Final.grepresentacion = dgvDataListado2.Rows(i).Cells.Item("Representa").Value
                    ...
                    Funcio_Atleta_Competencia.editar(Atleta_Competencia_Final)
                Next
        ...
        If dgvDataListado3.Rows.Count > 0 Then
            Try
                For i As Integer = 0 To dgvDataListado3.Rows.Count - 1
                    ...
                    Resultado_Final.gtiempo = dgvDataListado3.Rows(i).Cells.Item("Tiempo").Value
                    Resultado_Final.gposicion = dgvDataListado3.Rows(i).Cells.Item("Posición").Value

                    'ACTUALIZA LA TABLA ATLETAS POR COMPETENCIA
                    Atleta_Competencia_Final.gid_atleta_x_competencia = txtIdAtleta_x_Competencia3.Text
                    Atleta_Competencia_Final.gid_atleta = dgvDataListado3.Rows(i).Cells.Item("Id_Atleta").Value
                    Atleta_Competencia_Final.gid_resultado = txtIdResultado3.Text
                    Atleta_Competencia_Final.gdorsal = dgvDataListado3.Rows(i).Cells.Item("Dorsal").Value
                    Atleta_Competencia_Final.grepresentacion = dgvDataListado3.Rows(i).Cells.Item("Representa").Value
