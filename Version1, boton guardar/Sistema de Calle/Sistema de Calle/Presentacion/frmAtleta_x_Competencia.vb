Public Class frmAtletas_x_Competencia
    ...
    Private Sub frmAtletas_x_Competencia_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        btnComienzar1.Enabled = False 'DESACTIVA EL BOTON DAR COMIENZO (HASTA QUE SE GUARDE EL LISTADO)
    ...
    Private Sub btnGuardar_Click(sender As System.Object, e As System.EventArgs) Handles btnGuardar1.Click
        ...
        Try
            For Each rows As DataGridViewRow In Me.dgvDataListado1.Rows
                ...
                rows.Cells(6).Value = func.Nuevo_Codigo_Resultado
                ...
                rows.Cells(6).Value = func.Nuevo_Codigo_Resultado
                atl_x_comp.gid_resultado = rows.Cells(6).Value
    ...
    Private Sub btnGuardar3_Click(sender As System.Object, e As System.EventArgs) Handles btnGuardar3.Click
        ...
        Try
            For Each rows As DataGridViewRow In Me.dgvDataListado3.Rows
                ...
                func.insertar(resultado)
                'RECORRE EL DATAGRID Y GUARDA EN LA TABLA "ATLETAS_POR_COMPETENCIA"
                atl_x_comp.gid_atleta_x_competencia = txtIdAtleta_x_Competencia3.Text 'id_atleta_x_competencia
                atl_x_comp.gid_atleta = rows.Cells(2).Value 'id_atleta
                atl_x_comp.gdorsal = rows.Cells(3).Value 'dorsal
                atl_x_comp.grepresentacion = rows.Cells(4).Value 'representacion
    ...
    Private Sub Ordenar()
        ...
        cont = 0
        For Each rows As DataGridViewRow In Me.dgvDataListado1.Rows
            If COLUMNA_MEJOR_TIEMPO <> btnSinTiempo1.Text Then
                cont = cont + 1
    ...
    Private Sub btnActualizar2_Click(sender As System.Object, e As System.EventArgs) Handles btnActualizar2.Click
        If dgvDataListado2.Rows.Count > 0 Then
            Try
                For i As Integer = 0 To dgvDataListado2.Rows.Count - 1

                    'ACTUALIZA LA TABLA RESULTADO
                    Resultado_Final.gid_resultado = txtIdResultado2.Text
                    Resultado_Final.gtiempo = dgvDataListado2.Rows(i).Cells.Item("Tiempo1").Value
                    Resultado_Final.gposicion = dgvDataListado2.Rows(i).Cells.Item("Posición1").Value

                    'ACTUALIZA LA TABLA ATLETAS POR COMPETENCIA
                    Atleta_Competencia_Final.gid_atleta_x_competencia = txtIdAtleta_x_Competencia2.Text
                    Atleta_Competencia_Final.gid_atleta = dgvDataListado2.Rows(i).Cells.Item("Id_Atleta1").Value
                    Atleta_Competencia_Final.gid_resultado = txtIdResultado2.Text
                    Atleta_Competencia_Final.gdorsal = dgvDataListado2.Rows(i).Cells.Item("Dorsal1").Value
                    Atleta_Competencia_Final.grepresentacion = dgvDataListado2.Rows(i).Cells.Item("Representa1").Value
    ...
    '                'ACTUALIZA LA TABLA RESULTADO
    '                Resultado_Final.gid_resultado = txtIdResultado3.Text
    '                Resultado_Final.gtiempo = dgvDataListado3.Rows(i).Cells.Item("Tiempo2").Value
    '                Resultado_Final.gposicion = dgvDataListado3.Rows(i).Cells.Item("Posición2").Value

    '                'ACTUALIZA LA TABLA ATLETAS POR COMPETENCIA
    '                Atleta_Competencia_Final.gid_atleta_x_competencia = txtIdAtleta_x_Competencia3.Text
    '                Atleta_Competencia_Final.gid_atleta = dgvDataListado3.Rows(i).Cells.Item("Id_Atleta2").Value
    '                Atleta_Competencia_Final.gid_resultado = txtIdResultado3.Text
    '                Atleta_Competencia_Final.gdorsal = dgvDataListado3.Rows(i).Cells.Item("Dorsal2").Value
    '                Atleta_Competencia_Final.grepresentacion = dgvDataListado3.Rows(i).Cells.Item("Representa2").Value
    ...
    Private Sub btnBuscarJuez3_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscarJuez3.Click
    ...
    Private Sub btnBuscarJuez2_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscarJuez2.Click
        frmJuez.txtFlag.Text = "1"
        frmJuez.ShowDialog()
    End Sub

    Private Sub btnActualizar1_Click_1(sender As System.Object, e As System.EventArgs) Handles btnActualizar1.Click
        ...
        If dgvDataListado1.Rows.Count > 0 Then
            Try
                For i As Integer = 0 To dgvDataListado1.Rows.Count - 1
                    ...
                    'ACTUALIZA LA TABLA RESULTADO
                    Resultado_Final.gid_resultado = txtIdResultado1.Text
                    Resultado_Final.gtiempo = dgvDataListado1.Rows(i).Cells.Item("Tiempo").Value
                    Resultado_Final.gposicion = dgvDataListado1.Rows(i).Cells.Item("Posición").Value

                    'ACTUALIZA LA TABLA ATLETAS POR COMPETENCIA
                    Atleta_Competencia_Final.gid_atleta_x_competencia = txtIdAtleta_x_Competencia1.Text
                    Atleta_Competencia_Final.gid_atleta = dgvDataListado1.Rows(i).Cells.Item("Id_Atleta").Value
                    Atleta_Competencia_Final.gid_resultado = txtIdResultado1.Text
                    Atleta_Competencia_Final.gdorsal = dgvDataListado1.Rows(i).Cells.Item("Dorsal").Value
                    Atleta_Competencia_Final.grepresentacion = dgvDataListado1.Rows(i).Cells.Item("Representa").Value
    ...
    Private Sub btnAgregarTiempo1_Click_1(sender As System.Object, e As System.EventArgs) Handles btnAgregarTiempo1.Click
    ...
    Private Sub btnSinTiempo1_Click_1(sender As System.Object, e As System.EventArgs)
        Dim filaActual = Me.dgvDataListado1.SelectedRows(0)
        If MessageBox.Show("Confirma ingresar el tiempo de: " & Environment.NewLine & CStr(filaActual.Cells(0).Value),
                           "Confirmar acción", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
