...
Public Class frmJuez
    ...
    Private Sub btnBuscar_Click_1(sender As System.Object, e As System.EventArgs) Handles btnBuscar.Click
        Dim Fila = Buscar_Juez_Dni(Datalistado, "Código", txtBuscar.Text)
    ...
    Private Sub btnNuevo_Click_2(sender As System.Object, e As System.EventArgs) Handles btnNuevo.Click
        Me.Width = 971
    End Sub
