...
Public Class NUEVOJUEZ
    ...
    Function getnombre() As String
        Return txtnombrejuez.Text = Nothing
    End Function
    ...
    Private Sub btnRegistrar_Click(sender As System.Object, e As System.EventArgs) Handles btnRegistrar.Click
        ...
        Catch ex As Exception
            MsgBox("No se pudo registrar al Juez", MsgBoxStyle.Critical, "Error")
        End Try
    ...
    Private Sub btnActualizarJuez_Click(sender As System.Object, e As System.EventArgs) Handles btnActualizarJuez.Click
        Try
            ...
            capanegocio.actualizarJuez(JuezSeleccionado)
            MessageBox.Show("Los datos del Juez han sido actualizados correctamente", "Actualizando Juez", MessageBoxButtons.OK, MessageBoxIcon.Information)
            LISTAJUECES.ShowDialog()
        Catch ex As Exception
            MsgBox("No se pudieron actualizar los datos del Juez", MsgBoxStyle.Critical, "Error")
        End Try
    End Sub
