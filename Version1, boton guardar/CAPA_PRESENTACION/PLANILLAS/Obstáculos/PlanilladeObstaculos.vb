...
Public Class PlanilladeObstaculos

    Public Property TipoDeFormulario As TipoFormulario
    Shared Property CompetenciaSeleccionada As New CECompetencias

    Private Sub PlanilladeObstaculos_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
    End Sub
    ...
    Private Sub btnAgregarSerie1_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregarSerie1.Click
        If rbtSerie1.Checked = True Then
            ...
            For Each row As DataGridViewRow In FilasSeleccionadas
                PlanilladeSeriesdeObstaculos.dgvSerie1.Rows.Add(row.Cells(1).Value, row.Cells(2).Value)
        ...
        For Each row As DataGridViewRow In nuevo
            PlanilladeSeriesdeObstaculos.dgvSerie1.Rows.Add(New Object() {row.Cells(0).Value, row.Cells(1).Value})
        Next
    ...
    Private Sub btnAgregarSerie2_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregarSerie2.Click
        If rbtSerie2.Checked = True Then
            ...
            'eliminando la fila del grid original
            For Each row As DataGridViewRow In FilasSeleccionadas
                PlanilladeSeriesdeObstaculos.dgvSerie2.Rows.Add(row.Cells(1).Value, row.Cells(2).Value)
                dgvPlanillaObstaculos.Rows.Remove(row)
            Next
        End If
        Dim nuevo As New List(Of DataGridViewRow)
        ...
        Next
        For Each row As DataGridViewRow In nuevo
            PlanilladeSeriesdeObstaculos.dgvSerie2.Rows.Add(New Object() {row.Cells(0).Value, row.Cells(1).Value})
        Next
    End Sub
    ...
    Private Sub btnAgregarSerie3_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregarSerie3.Click
        If rbtSerie3.Checked = True Then
            ...
            'eliminando la fila del grid original
            For Each row As DataGridViewRow In FilasSeleccionadas
                PlanilladeSeriesdeObstaculos.dgvSerie3.Rows.Add(row.Cells(1).Value, row.Cells(2).Value)
                dgvPlanillaObstaculos.Rows.Remove(row)
            Next
        End If
        ...
        Next
        For Each row As DataGridViewRow In nuevo
            PlanilladeSeriesdeObstaculos.dgvSerie3.Rows.Add(New Object() {row.Cells(0).Value, row.Cells(1).Value})
        Next

    End Sub

    Private Sub btnAceptar_Click(sender As System.Object, e As System.EventArgs) Handles btnAceptar.Click
        PlanilladeSeriesdeObstaculos.ShowDialog()
    End Sub
    ...
    Private Sub btnComenzar_Click(sender As System.Object, e As System.EventArgs) Handles btnComenzar.Click
        ...
        If dgv.Rows.Count >= 1 And dgv.Rows.Count <= 8 Then
            rbtSerie1.Enabled = True
            rbtSerie1.Checked = True
            btnAgregarSerie1.Enabled = True
            btnAceptar.Enabled = True

        ElseIf dgv.Rows.Count >= 9 And dgv.Rows.Count <= 16 Then
        ...
        ElseIf dgv.Rows.Count >= 17 And dgv.Rows.Count <= 24 Then
    ...
    Shared Sub AgregarRegistroAGrilla(atleta As CEAtletas)
        ...
        PlanilladeObstaculos.dgvPlanillaObstaculos.Rows.Add(0,
                                                            atleta.dorsal,
