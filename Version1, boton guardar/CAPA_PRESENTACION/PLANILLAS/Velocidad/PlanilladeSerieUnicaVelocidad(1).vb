...
Public Class PlanilladeSerieUnicaVelocidad
    ...
    Private Sub btnActualizar_Click(sender As System.Object, e As System.EventArgs) Handles btnActualizar.Click
        If dgvSerieUnica.Rows.Count > 0 Then
            Try
                For i As Integer = 0 To dgvSerieUnica.Rows.Count - 1
                    ResultadoFinalSeleccionado.id_resultado_x_competencia = dgvSerieUnica.Rows(i).Cells.Item("Id_Resultados_X_Competencia").Value
                    ResultadoFinalSeleccionado.id_competencia = txtCodigoVelocidad.Text
                    ResultadoFinalSeleccionado.id_atleta = dgvSerieUnica.Rows(i).Cells.Item("Id_Atleta").Value
                    ResultadoFinalSeleccionado.mejor = dgvSerieUnica.Rows(i).Cells.Item("Mejor").Value
                    ResultadoFinalSeleccionado.posicion = dgvSerieUnica.Rows(i).Cells.Item("Posicion").Value
                    ResultadoFinalSeleccionado.serie = dgvSerieUnica.Rows(i).Cells.Item("Serie").Value
                    ResultadoFinalSeleccionado.valor = txtValor.Text
                    ResultadoFinalSeleccionado.descripcion = dgvSerieUnica.Rows(i).Cells.Item("Descripción").Value
                    ResultadoFinalSeleccionado.id_juez = PlanillaDeVelocidad.cboJuez1.SelectedValue
                    ResultadoFinalSeleccionado.dorsal = dgvSerieUnica.Rows(i).Cells.Item("Dorsal").Value

                    AtletaxCompetenciaSeleccionada.id_atleta = dgvSerieUnica.Rows(i).Cells.Item("Id_Atleta").Value
                    AtletaxCompetenciaSeleccionada.id_competencia = txtCodigoVelocidad.Text
                    AtletaxCompetenciaSeleccionada.id_resultado_competencia = dgvSerieUnica.Rows(i).Cells.Item("Id_Resultados_X_Competencia").Value
    ...
    Private Sub PlanilladeSerieUnicaFondo_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
    End Sub
    ...
    Private Sub btnAgregarTiempo_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregarTiempo.Click
        ...
        If Me.dgvSerieUnica.Rows.Count = 0 Then
        ...
        Dim filaActual = Me.dgvSerieUnica.SelectedRows(0)
    ...
    Private Sub Ordenar()
        ...
        dgvSerieUnica.Sort(dgvSerieUnica.Columns(8), System.ComponentModel.ListSortDirection.Ascending)

        Dim cont As Integer
        cont = 0

        For Each rows As DataGridViewRow In Me.dgvSerieUnica.Rows
            cont = cont + 1
        ...
        For i As Integer = COLUMNA_PRIMER_TIEMPO To COLUMNA_TERCER_TIEMPO
            ...
            If String.IsNullOrEmpty(CStr(filaActual.Cells(i).Value).Trim()) OrElse CStr(filaActual.Cells(i).Value).Trim() = "00:00:00" Then 'busca la primer posición vacía d las celdas 4,5,6
                ...
                If i = COLUMNA_TERCER_TIEMPO Then
                    ...
                    Dim fila = dgvSerieUnica.CurrentRow
    ...
    Private Sub btnInformeFinal_Click(sender As System.Object, e As System.EventArgs) Handles btnInformeFinal.Click
        PlanillaFinalVelocidad.txtEstado.Text = "Finalizada"
        ...
        PlanillaFinalVelocidad.cboCategoria.Text = Me.cboCategoria.Text
        PlanillaFinalVelocidad.Show()

    End Sub
    Sub cargarlista()
        dgvSerieUnica.DataSource = capanegocio2.Ultimo_Registro_Atleta_x_Competencia_Velocidad.Tables("Ultimo_Registro_Atleta_x_Competencia_Velocidad")
        dgvSerieUnica.Columns(0).HeaderText = "Código"
        dgvSerieUnica.Columns(0).Visible = False
        dgvSerieUnica.Columns(1).HeaderText = "Dorsal"
        dgvSerieUnica.Columns(2).HeaderText = "Nombre"
        dgvSerieUnica.Columns(3).HeaderText = "Apellido"
        dgvSerieUnica.Columns(4).HeaderText = "Club/Federación"
        dgvSerieUnica.Columns(5).HeaderText = "1° Tiempo"
        dgvSerieUnica.Columns(6).HeaderText = "2° Tiempo"
        dgvSerieUnica.Columns(7).HeaderText = "3° Tiempo"
        dgvSerieUnica.Columns(8).HeaderText = "Mejor Tiempo"
        dgvSerieUnica.Columns(9).HeaderText = "Posición"
        dgvSerieUnica.Columns(10).HeaderText = "Serie"
        dgvSerieUnica.Columns(10).Visible = False
        dgvSerieUnica.Columns(11).HeaderText = "Descripción"
        dgvSerieUnica.Columns(11).Visible = False
        dgvSerieUnica.Columns(12).HeaderText = "Código Resultado"
        dgvSerieUnica.Columns(12).Visible = False
    End Sub
    
    Private Sub dgvSerieUnica_CellFormatting(sender As Object, e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dgvSerieUnica.CellFormatting
        e.CellStyle.SelectionBackColor = Color.Azure
        e.CellStyle.SelectionForeColor = Color.Black
        Try
            If Me.dgvSerieUnica.Columns(e.ColumnIndex).Name = "Tiempo Juez 1" Then
                ...
                End If
            End If
            If Me.dgvSerieUnica.Columns(e.ColumnIndex).Name = "Tiempo Juez 2" Then
                If e.Value IsNot Nothing Then
                    Dim valor As String = CType(e.Value, String)
                    If (valor >= "00:00:00") Then
                        e.CellStyle.BackColor = Color.GreenYellow
                ...
                End If
            End If
            If Me.dgvSerieUnica.Columns(e.ColumnIndex).Name = "Tiempo Juez 3" Then
                If e.Value IsNot Nothing Then
                    Dim valor As String = CType(e.Value, String)
                    If (valor >= "00:00:00") Then
                        e.CellStyle.BackColor = Color.GreenYellow
                ...
                End If
            End If
            If Me.dgvSerieUnica.Columns(e.ColumnIndex).Name = "Mejor" Then
                If e.Value IsNot Nothing Then
                    Dim valor As String = CType(e.Value, String)
                    If (valor >= "00:00:00") Then
