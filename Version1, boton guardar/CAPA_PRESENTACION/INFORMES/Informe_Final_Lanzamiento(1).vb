...
Public Class Informe_Final_Lanzamiento
    ...
    Private Sub Informe_Final_Lanzamiento_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        Me.dgvLanzamientoMaestro.DataSource = ds
        Me.dgvLanzamientoMaestro.DataMember = "Competencia"


        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvLanzamientoDetalle.DataSource = ds
        Me.dgvLanzamientoDetalle.DataMember = "Competencia.Competencia_Atletas"
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        Dim objForm As New Lanzamiento_x_Id
        Dim id_comp As Integer = dgvLanzamientoMaestro.CurrentRow.Cells(0).Value
        frm_Lanzamiento_x_Id.id_competencia = id_comp
        frm_Lanzamiento_x_Id.ShowDialog()
    End Sub
End Class