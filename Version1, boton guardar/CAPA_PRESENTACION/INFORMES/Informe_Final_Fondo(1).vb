...
Public Class Informe_Final_Fondo
    ...
    Private Sub Informe_Final_Fondo_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        Me.dgvFondoMaestro.DataSource = ds
        Me.dgvFondoMaestro.DataMember = "Competencia"


        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvFondoDetalle.DataSource = ds
        Me.dgvFondoDetalle.DataMember = "Competencia.Competencia_Atletas"
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        Dim objForm As New Fondo_x_Id
        Dim id_comp As Integer = dgvFondoMaestro.CurrentRow.Cells(0).Value
        frm_Fondo_x_Id.id_competencia = id_comp
        frm_Fondo_x_Id.ShowDialog()
    End Sub
End Class