...
Public Class Informe_Final_Obstáculos
    ...
    Private Sub Informe_Final_Obstáculos_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        If dgvObstaculosMaestro.Rows.Count = 0 Then

            MessageBox.Show("No existen Competencias de Obstáculos Registradas", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Close()
        Else
            Me.dgvObstaculosMaestro.DataSource = ds
            Me.dgvObstaculosMaestro.DataMember = "Competencia"
        End If
        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvObstaculosDetalle.DataSource = ds
        Me.dgvObstaculosDetalle.DataMember = "Competencia.Competencia_Atletas"
    End Sub
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        ...
        Dim id_comp As Integer = dgvObstaculosMaestro.CurrentRow.Cells(0).Value
        frm_Obstaculos_x_Id.id_competencia = id_comp
        frm_Obstaculos_x_Id.ShowDialog()
    End Sub
End Class