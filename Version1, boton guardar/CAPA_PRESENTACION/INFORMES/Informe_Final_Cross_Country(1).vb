...
Public Class Informe_Final_Cross_Country
    ...
    Private Sub Informe_Final_Cross_Country_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        Me.dgvInformeFinalCrossCountry.DataSource = ds
        Me.dgvInformeFinalCrossCountry.DataMember = "Competencia"


        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvAtletasCrossCountry.DataSource = ds
        Me.dgvAtletasCrossCountry.DataMember = "Competencia.Competencia_Atletas"
    End Sub
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        Dim objForm As New Cross_Country_x_Id
        Dim id_comp As Integer = dgvInformeFinalCrossCountry.CurrentRow.Cells(0).Value
        frm_Cross_Country_x_Id.id_competencia = id_comp
        frm_Cross_Country_x_Id.ShowDialog()
    End Sub
End Class