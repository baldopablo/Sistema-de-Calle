...
Public Class Informe_Final_Velocidad
    ...
    Private Sub Informe_Final_Velocidad_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        If dgvVelocidadMaestro.Rows.Count = 0 Then

            MessageBox.Show("No existen Competencias de Velocidad Registradas", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Close()
        Else
            Me.dgvVelocidadMaestro.DataSource = ds
            Me.dgvVelocidadMaestro.DataMember = "Competencia"

        End If

        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvVelocidadDetalle.DataSource = ds
        Me.dgvVelocidadDetalle.DataMember = "Competencia.Competencia_Atletas"
    End Sub
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        Dim objForm As New Velocidad_x_Id
        Dim id_comp As Integer = dgvVelocidadMaestro.CurrentRow.Cells(0).Value
        frm_Velocidad_x_Id.id_competencia = id_comp
        frm_Velocidad_x_Id.ShowDialog()
    End Sub
End Class