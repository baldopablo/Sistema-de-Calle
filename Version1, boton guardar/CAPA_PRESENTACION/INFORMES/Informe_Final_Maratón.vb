...
Public Class Informe_Final_Maratón
    ...
    Private Sub Informe_Final_Maratón_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        Me.dgvMaratonMaestro.DataSource = ds
        Me.dgvMaratonMaestro.DataMember = "Competencia"


        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvMaratonDetalle.DataSource = ds
        Me.dgvMaratonDetalle.DataMember = "Competencia.Competencia_Atletas"
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        Dim objForm As New Maraton_x_Id
        Dim id_comp As Integer = dgvMaratonMaestro.CurrentRow.Cells(0).Value
        frm_Maraton_x_Id.id_competencia = id_comp
        frm_Maraton_x_Id.ShowDialog()
    End Sub
End Class