...
Public Class Informe_Final_Salto
    ...
    Private Sub Informe_Final_Salto_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        Me.dgvSaltoMaestro.DataSource = ds
        Me.dgvSaltoMaestro.DataMember = "Competencia"


        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvSaltoDetalle.DataSource = ds
        Me.dgvSaltoDetalle.DataMember = "Competencia.Competencia_Atletas"
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        Dim objForm As New Salto_x_Id
        Dim id_comp As Integer = dgvSaltoMaestro.CurrentRow.Cells(0).Value
        frm_Salto_x_Id.id_competencia = id_comp
        frm_Salto_x_Id.ShowDialog()
    End Sub
End Class