...
Public Class Informe_Final_Medio_Fondo
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles btnCerrar.Click
        Me.Close()

    End Sub

    Private Sub Informe_Final_Medio_Fondo_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrepararFormulario()
        ...
        If dgvMedioFondoMaestro.Rows.Count = 0 Then
            MessageBox.Show("No existen Competencias de Medio Fondo Registradas", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Close()
        Else
            Me.dgvMedioFondoMaestro.DataSource = ds
            Me.dgvMedioFondoMaestro.DataMember = "Competencia"
        End If
        'asignar al datagridview detalles la relacion ue acabamos de crear por codigo
        Me.dgvMedioFondoDetalle.DataSource = ds
        Me.dgvMedioFondoDetalle.DataMember = "Competencia.Competencia_Atletas"
    End Sub
    ...
    Private Sub btnReporte_Click(sender As System.Object, e As System.EventArgs) Handles btnReporte.Click
        Dim objForm As New Medio_Fondo_x_Id
        Dim id_comp As Integer = dgvMedioFondoMaestro.CurrentRow.Cells(0).Value
        frm_Medio_Fondo_x_Id.id_competencia = id_comp
        frm_Medio_Fondo_x_Id.ShowDialog()
    End Sub
End Class