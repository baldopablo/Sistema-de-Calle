...
Public Class NUEVACOMPETENCIA
    ...
    'EL USUARIO QUE INGRESA AL SISTEMA ES EL USUARIO QUE VA A APARECER EN EL COMBOBOX DE LA NUEVA COMPETENCIA, VERIFICAR ESO!!!

    Sub UsuarioPrincipal()
        cboUsuario.DataSource = capanegocio.UsuarioPrincipal.Tables("UsuarioPrincipal")
        cboUsuario.DisplayMember = "Apellido_Usu"
        cboUsuario.ValueMember = "Id_Usuario"
        'cboUsuario.SelectedIndex = 11
    End Sub
    ...
    Private Sub PrepararFormulario()
        ...
        Select Case TipoDeFormulario
            ...
            Case TipoFormulario.Alta
                ...
                Label9.Visible = False
                Label11.Visible = False
                cboJuez1.Visible = True
                cboJuez2.Visible = True
                cboJuez3.Visible = True
                Label4.Visible = False
                txtCodigoCompetencia.Visible = False
                Label8.Visible = True
    ...
    Private Sub btnCrearCompetencia_Click(sender As System.Object, e As System.EventArgs) Handles btnCrear.Click
        ...
        If rbtCalle.Checked = True Then
            PlanillaDeCalle.txtCodigoPlanillaCalle.Text = Me.txtCodigoCompetencia.Text
            PlanillaDeCalle.txtNombre.Text = Me.txtNombreCompetencia.Text
            PlanillaDeCalle.txtLugar.Text = Me.txtLugarCompetenciaCalle.Text
            PlanillaDeCalle.cboProvincia.Text = Me.cboProvinciaCompetencia.Text
            PlanillaDeCalle.cboLocalidad.Text = Me.cboLocalidadCompetenciaCalle.Text
            PlanillaDeCalle.dtpfechainicio.Text = Me.dtpFechaInicioCompetenciaCalle.Text
            PlanillaDeCalle.txtHora.Text = Me.txtHora.Text
            PlanillaDeCalle.txtDistanciaCompetenciaCalle.Text = Me.txtDistanciaCompetenciaCalle.Text
            PlanillaDeCalle.txtEstado.Text = Me.txtEstado.Text
            PlanillaDeCalle.cboJuez1.Text = Me.cboJuez1.Text
            PlanillaDeCalle.cboJuez2.Text = Me.cboJuez2.Text
            PlanillaDeCalle.cboJuez3.Text = Me.cboJuez3.Text
            PlanillaDeCalle.cboUsuario.Text = Me.cboUsuario.Text

            PlanillaDeCalle.ShowDialog()
        End If
        ...
        If rbtPistayCampo.Checked = True And cboDisciplinas.Text = "Fondo" Then
            PlanilladeFondoCargadeAtletas.txtCodigoFondo.Text = Me.txtCodigoCompetencia.Text
            PlanilladeFondoCargadeAtletas.txtNombre.Text = Me.txtNombreCompetencia.Text
            PlanilladeFondoCargadeAtletas.txtLugar.Text = Me.txtLugarCompetenciaCalle.Text
            PlanilladeFondoCargadeAtletas.cboProvincia.Text = Me.cboProvinciaCompetencia.Text
            PlanilladeFondoCargadeAtletas.cboLocalidad.Text = Me.cboLocalidadCompetenciaCalle.Text
            PlanilladeFondoCargadeAtletas.dtpfechainicio.Text = Me.dtpFechaInicioCompetenciaCalle.Text
            PlanilladeFondoCargadeAtletas.txtHora.Text = Me.txtHora.Text
            PlanilladeFondoCargadeAtletas.txtEstado.Text = Me.txtEstado.Text
            PlanilladeFondoCargadeAtletas.cboJuez1.Text = Me.cboJuez1.Text
            PlanilladeFondoCargadeAtletas.cboJuez2.Text = Me.cboJuez2.Text
            PlanilladeFondoCargadeAtletas.cboJuez3.Text = Me.cboJuez3.Text
            PlanilladeFondoCargadeAtletas.cboUsuario.Text = Me.cboUsuario.Text
            PlanilladeFondoCargadeAtletas.cboPrueba.Text = Me.cboPruebas.Text

            PlanilladeFondoCargadeAtletas.ShowDialog()
        End If
