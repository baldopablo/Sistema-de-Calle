...
Public Class NUEVOCLUBFEDERACION
    ...
    Private Sub btnRegistrar_Click(sender As System.Object, e As System.EventArgs) Handles btnRegistrar.Click
        ...
        Try
            ...
            txtCodigoClub.Clear()
            generacodigoclub()
            MessageBox.Show("El Club/Federación ha sido registrado correctamente", "Creando Club/Federación", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnActualizar_Click(sender As System.Object, e As System.EventArgs) Handles btnActualizar.Click
        Try
            ...
            capanegocio.actualizarClub(ClubSeleccionado)
            MessageBox.Show("Los datos del Club/Federación han sido actualizados correctamente", "Actualizando Club/Federación", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Me.Hide()
            LISTADOCLUBFEDERACION.ShowDialog()

        Catch ex As Exception
            MsgBox("Error al actualizar los datos del Club/Federación", MsgBoxStyle.Critical, "Error")
        End Try
    End Sub
