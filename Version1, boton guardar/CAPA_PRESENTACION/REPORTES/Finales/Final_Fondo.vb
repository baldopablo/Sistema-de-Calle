...
Public Class Final_Fondo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Fondo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Fondo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Fondo = New Final_Fondo()
        rpt.Site = Me.Site
        Return rpt
    End Function
