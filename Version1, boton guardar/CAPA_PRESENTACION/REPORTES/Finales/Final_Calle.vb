...
Public Class Final_Calle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Calle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Calle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Calle = New Final_Calle()
        rpt.Site = Me.Site
        Return rpt
    End Function
