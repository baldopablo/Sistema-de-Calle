...
Public Class Final_Lanzamiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Lanzamiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Lanzamiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Lanzamiento = New Final_Lanzamiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
