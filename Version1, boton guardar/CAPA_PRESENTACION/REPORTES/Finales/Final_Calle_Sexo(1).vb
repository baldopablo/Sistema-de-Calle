...
Public Class Final_Calle_Sexo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Calle_Sexo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Calle_Sexo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Calle_Sexo = New Final_Calle_Sexo()
        rpt.Site = Me.Site
        Return rpt
    End Function
