...
Public Class Final_Velocidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Velocidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Velocidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Velocidad = New Final_Velocidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
