...
Public Class Final_Obstaculos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Obstaculos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Obstaculos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Obstaculos = New Final_Obstaculos()
        rpt.Site = Me.Site
        Return rpt
    End Function
