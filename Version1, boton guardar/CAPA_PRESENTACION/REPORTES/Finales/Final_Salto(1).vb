...
Public Class Final_Salto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Salto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Salto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Salto = New Final_Salto()
        rpt.Site = Me.Site
        Return rpt
    End Function
