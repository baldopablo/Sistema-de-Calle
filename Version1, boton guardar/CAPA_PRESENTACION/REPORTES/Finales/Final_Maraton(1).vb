...
Public Class Final_Maraton
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Maraton.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Maraton
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Maraton = New Final_Maraton()
        rpt.Site = Me.Site
        Return rpt
    End Function
