...
Public Class Final_Medio_Fondo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Medio_Fondo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Medio_Fondo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Medio_Fondo = New Final_Medio_Fondo()
        rpt.Site = Me.Site
        Return rpt
    End Function
