...
Public Class Final_Marcha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Final_Marcha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinal_Marcha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Final_Marcha = New Final_Marcha()
        rpt.Site = Me.Site
        Return rpt
    End Function
