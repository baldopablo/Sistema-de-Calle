...
Public Class ListadodeClubes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.ListadodeClubes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadodeClubes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadodeClubes = New ListadodeClubes()
        rpt.Site = Me.Site
        Return rpt
    End Function
