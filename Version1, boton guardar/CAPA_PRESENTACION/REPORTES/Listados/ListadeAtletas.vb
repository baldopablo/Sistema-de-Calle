...
Public Class ListadeAtletas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.ListadeAtletas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadeAtletas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadeAtletas = New ListadeAtletas()
        rpt.Site = Me.Site
        Return rpt
    End Function
