...
Public Class ListadeJueces
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.ListadeJueces.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadeJueces
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadeJueces = New ListadeJueces()
        rpt.Site = Me.Site
        Return rpt
    End Function
