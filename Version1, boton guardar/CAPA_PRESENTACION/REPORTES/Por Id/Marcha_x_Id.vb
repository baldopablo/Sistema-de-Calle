...
Public Class Marcha_x_Id
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Marcha_x_Id.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMarcha_x_Id
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Marcha_x_Id = New Marcha_x_Id()
        rpt.Site = Me.Site
        Return rpt
    End Function
