...
Public Class Cross_Country_x_Id
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Cross_Country_x_Id.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Id_Competencia() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCross_Country_x_Id
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cross_Country_x_Id = New Cross_Country_x_Id()
        rpt.Site = Me.Site
        Return rpt
    End Function
