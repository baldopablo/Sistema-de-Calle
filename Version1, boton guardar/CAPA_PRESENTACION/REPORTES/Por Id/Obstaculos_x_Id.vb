...
Public Class Obstaculos_x_Id
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Obstaculos_x_Id.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedObstaculos_x_Id
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Obstaculos_x_Id = New Obstaculos_x_Id()
        rpt.Site = Me.Site
        Return rpt
    End Function
