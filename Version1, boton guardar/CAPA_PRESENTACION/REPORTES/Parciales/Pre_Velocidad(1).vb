...
Public Class Pre_Velocidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Pre_Velocidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPre_Velocidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pre_Velocidad = New Pre_Velocidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
