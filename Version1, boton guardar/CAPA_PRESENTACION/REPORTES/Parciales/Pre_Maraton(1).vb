...
Public Class Pre_Maraton
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Pre_Maraton.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPre_Maraton
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pre_Maraton = New Pre_Maraton()
        rpt.Site = Me.Site
        Return rpt
    End Function
