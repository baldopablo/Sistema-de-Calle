...
Public Class Pre_Cross_Country
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Pre_Cross_Country.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPre_Cross_Country
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pre_Cross_Country = New Pre_Cross_Country()
        rpt.Site = Me.Site
        Return rpt
    End Function
