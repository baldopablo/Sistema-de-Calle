...
Public Class Pre_Medio_Fondo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Pre_Medio_Fondo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPre_Medio_Fondo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pre_Medio_Fondo = New Pre_Medio_Fondo()
        rpt.Site = Me.Site
        Return rpt
    End Function
