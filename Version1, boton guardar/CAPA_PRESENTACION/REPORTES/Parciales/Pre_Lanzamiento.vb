...
Public Class Pre_Lanzamiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Pre_Lanzamiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPre_Lanzamiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pre_Lanzamiento = New Pre_Lanzamiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
