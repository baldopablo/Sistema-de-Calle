...
Public Class Pre_Obstaculos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.Pre_Obstaculos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPre_Obstaculos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pre_Obstaculos = New Pre_Obstaculos()
        rpt.Site = Me.Site
        Return rpt
    End Function
