...
Public Class DAOCompetencias
    ...
    Public Function ListaCompetenciaCalle() As DataSet
        ...
        cn = objcon.Conectar
        da = New SqlDataAdapter("Lista_Competencia_Calle", cn)
    ...
    Public Function Lista_Competencia_Pista() As DataSet
        Dim ds As New DataSet
        cn = objcon.Conectar
        da = New SqlDataAdapter("Lista_Competencia_Pista", cn)
    ...
    Public Function ListadoDeCompetenciasDTO() As List(Of CECompetencias)
        ...
        For Each row In miDS.Tables(0).Rows
            ...
            com.nombre_disciplina = row("Nombre_Disciplina")
            com.id_localidad = row("Id_Localidad")
            com.nombre_localidad = row("Nombre_Localidad")
            com.id_provincia = row("Id_Provincia")
            com.provincia = row("Nombre_Provincia")
            com.id_prueba = row("Id_Prueba")
            com.nombre_prueba = row("Nombre_Prueba")
    ...
    'LISTADO DE COMPETENCIA CALLE DTO
    Public Function ListadoCompetenciaCalleDTO() As List(Of CECompetencias)
        ...
        For Each row In miDS.Tables(0).Rows
            ...
            calle.Nombre_Disciplina = row("Nombre_Disciplina")
            calle.id_localidad = row("Id_Localidad")
            calle.nombre_localidad = row("Nombre_Localidad")
            calle.id_provincia = row("Id_Provincia")
            calle.provincia = row("Nombre_Provincia")
            calle.id_prueba = row("Id_Prueba")
            calle.Nombre_prueba = row("Nombre_Prueba")
            calle.lugar_competencia = row("Lugar")
            calle.Nombre_competencia = row("Nombre")
            calle.otra = row("Otra")
            calle.juez1 = row("Id_Juez")
            calle.juez2 = row("Id_Juez")
            calle.juez3 = row("Id_Juez")
    ...
    Public Function ListadoCompetenciaPistaDTO() As List(Of CECompetencias)
        Dim miDS = Lista_Competencia_Pista()
        ...
        For Each row In miDS.Tables(0).Rows
            ...
            pista.id_competencia = row("Id_Competencia")
            pista.id_disciplina = row("Id_Disciplina")
            pista.Nombre_Disciplina = row("Nombre_Disciplina")
            pista.id_localidad = row("Id_Localidad")
            pista.nombre_localidad = row("Nombre_Localidad")
            pista.id_provincia = row("Id_Provincia")
            pista.provincia = row("Nombre_Provincia")
            pista.id_prueba = row("Id_Prueba")
            pista.Nombre_prueba = row("Nombre_Prueba")
            pista.lugar_competencia = row("Lugar")
            pista.Nombre_competencia = row("Nombre")
            pista.otra = row("Otra")
            pista.juez1 = row("Id_Juez")
            pista.juez2 = row("Id_Juez")
            pista.juez3 = row("Id_Juez")
