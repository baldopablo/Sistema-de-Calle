...
Public Class DAOVarios
    ...
    'Function Id_Resultado_Parcial(Id_Resultado As Object) As Integer

    '    Dim ds As DataSet = New DataSet()
    '    cn = objcon.Conectar 'objeto de conexion conectada por medio de la funcion conectar
    '    da = New SqlDataAdapter("Id_Resultado", cn)
    '    da.SelectCommand.CommandType = CommandType.StoredProcedure
    '    With da.SelectCommand.Parameters
    '        .Add("@Id_Resultado_Parcial", SqlDbType.Int).Value = Id_Resultado
    '    End With
    '    da.Fill(ds)
    '    Return ds.Tables(0).Rows(0)("Id_Resultado_Parcial")
    'End Function
End Class
