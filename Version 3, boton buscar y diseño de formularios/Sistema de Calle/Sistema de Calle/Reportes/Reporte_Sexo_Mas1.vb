...
Public Class Reporte_Sexo_Mas1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Calle.Reporte_Sexo_Mas1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Sexo_Mas1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Sexo_Mas1 = New Reporte_Sexo_Mas1()
        rpt.Site = Me.Site
        Return rpt
    End Function
