...
Public Class Reporte_Edad_Sexo_Masculino
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_Edad_Sexo_Masculino.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Calle.Reporte_Edad_Sexo_Masculino.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_edadmas1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_edadmas2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_Edad_Sexo_Masculino
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Edad_Sexo_Masculino = New Reporte_Edad_Sexo_Masculino()
        rpt.Site = Me.Site
        Return rpt
    End Function
