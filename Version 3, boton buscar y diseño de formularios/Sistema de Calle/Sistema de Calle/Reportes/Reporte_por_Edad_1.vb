...
Public Class Reporte_por_Edad_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Calle.Reporte_por_Edad_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_edad1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_edad2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_por_Edad_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_por_Edad_1 = New Reporte_por_Edad_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
